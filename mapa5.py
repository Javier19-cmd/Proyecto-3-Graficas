...
class Raycaster5(object):
    ...
    def cargar_mapa2(self):
        ...
        r6 = Raycaster6(screen2) #Crea el raycaster.
        r6.load_map("map6.txt") #Carga el mapa.
        ...
        running = True
        while running: 
            screen2.fill(BLACK, (0, 0, r6.w, r6.h)) #Limpia la pantalla.
            screen2.fill(SKY, (r6.w/500, 0, r6.w, r6.h/2)) #Llena el cielo.
            screen2.fill(GROUND, (r6.w/500, r6.h/2, r6.w, r6.h/2)) #Llena el suelo.
