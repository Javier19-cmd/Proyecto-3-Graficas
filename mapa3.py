...
class Raycaster3(object):
    ...
    def cargar_mapa4(self):
        pygame.init() #Inicializa pygame.
        screen4 = pygame.display.set_mode((800, 800)) #Crea la pantalla.
        ...
        while running: 
            ...
            screen4.fill(SKY, (r3.w/500, 0, r3.w, r3.h/2)) #Llena el cielo.
            screen4.fill(GROUND, (r3.w/500, r3.h/2, r3.w, r3.h/2)) #Llena el suelo.
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_w: #Si se presiona la tecla arriba.
                        r3.player["x"] += cos(r3.player["a"]) * 50
                        r3.player["y"] += sin(r3.player["a"]) * 50
                        r3.collision(r3.player["x"], r3.player["y"])
    ...
    def collision(self, x, y):
        ...
        if self.map[j][i] == ' ': #Detectando el camino.
            ...
            print("¡Ganaste!")
            self.cargar_mapa4() #Llamando al tercer mapa.
